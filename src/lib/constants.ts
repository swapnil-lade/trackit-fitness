...
export const FITNESS_STATS_DATA = [
  { title: 'Calories Burned', value: '1850', unit: 'kcal', icon: Flame, color: 'text-red-500' },
  { title: 'Steps Taken', value: '10,520', unit: 'steps', icon: Footprints, color: 'text-blue-500' },
  { title: 'Current Workout', value: 'Rest Day', unit: '', icon: Dumbbell, color: 'text-green-500' },
  { title: 'Meals Logged', value: '3', unit: 'meals', icon: Utensils, color: 'text-orange-500' },
];
